...
complete -c tiger-hash -s G -l gost --description 'GOST: calculate and print GOST R 34.'
complete -c tiger-hash -l gost-cryptopro --description 'GOST-CRYPTOPRO: calculate and print CryptoPro version of the GOST R 34.'
...
complete -c tiger-hash -l file-list --description 'Process a file-list.'
...
complete -c tiger-hash -s m -l magnet --description 'Print hash sums formatted as magnet links.'
