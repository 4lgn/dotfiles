...
complete -c s_client -o ssl3 -o tls1 -o tls1_1 -o tls1_2 -o no_ssl3 -o no_tls1 -o no_tls1_1 -o no_tls1_2 --description 'These options require or disable the use of the specified \\s-1SSL\\s0 or \\s-1T…'
...
complete -c s_client -o alpn -o nextprotoneg --description 'these flags enable the  Enable the Application-Layer Protocol Negotiation or …'
complete -c s_client -o ct --description 'Use one of these two options to control whether Certificate Transparency (\\s-…'
