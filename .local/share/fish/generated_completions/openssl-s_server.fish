...
complete -c openssl-s_server -o naccept --description 'The server will exit after receiving number connections, default unlimited.'
complete -c openssl-s_server -o unix --description 'Unix domain socket to accept on.'
complete -c openssl-s_server -o unlink --description 'For -unix, unlink existing socket first.'
...
complete -c openssl-s_server -o crl_check -o crl_check_all --description 'Check the peer certificate has not been revoked by its \\s-1CA.'
...
complete -c openssl-s_server -o psk_hint --description 'Use the \\s-1PSK\\s0 identity hint hint when using a \\s-1PSK\\s0 cipher suite.'
complete -c openssl-s_server -o psk --description 'Use the \\s-1PSK\\s0 key key when using a \\s-1PSK\\s0 cipher suite.'
complete -c openssl-s_server -o ssl2 -o ssl3 -o tls1 -o tls1_1 -o tls1_2 -o no_ssl2 -o no_ssl3 -o no_tls1 -o no_tls1_1 -o no_tls1_2 --description 'These options require or disable the use of the specified \\s-1SSL\\s0 or \\s-1T…'
...
complete -c openssl-s_server -o bugs --description 'There are several known bug in \\s-1SSL\\s0 and \\s-1TLS\\s0 implementations.'
...
complete -c openssl-s_server -o cipher --description 'This allows the cipher list used by the server to be modified.'
...
complete -c openssl-s_server -o engine --description 'Specifying an engine (by its unique id string) will cause s_server to attempt…'
complete -c openssl-s_server -o id_prefix --description 'Generate \\s-1SSL/TLS\\s0 session IDs prefixed by arg.'
...
complete -c openssl-s_server -o status_timeout --description 'Sets the timeout for \\s-1OCSP\\s0 response to nsec seconds.'
