...
complete -c has160-hash -l file-list --description 'Process a file-list.'
complete -c has160-hash -l follow --description 'Follow symbolic links when processing directories recursively.'
